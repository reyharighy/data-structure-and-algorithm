...
void SortFiveThree::menuInterface() {
...
void SortFiveThree::sort() {
    ...
    if (sortChosen >= 1 && sortChosen <= 4) {
        if (sortChosen == 1 && array.size()) {
            ...
            std::cout << std::endl;
            mergeSort(arrayClone, 0, arrayClone.size() - 1, true);
            ...
            std::cout << std::endl;
            mergeSort(arrayClone, 0, arrayClone.size() - 1, false);
            std::cout << "Data setelah diurutkan: ";
            for (const auto& elem : arrayClone) {
                std::cout << elem << " ";
            }
            ...
            std::cout << std::endl;
            mergeSortString(arrayStringClone, 0, arrayStringClone.size() - 1, true);
            std::cout << "Data setelah diurutkan: ";
            for (const auto& elem : arrayStringClone) {
                std::cout << elem << " ";
            }
            ...
            std::cout << std::endl;
            mergeSortString(arrayStringClone, 0, arrayStringClone.size() - 1, false);
            std::cout << "Data setelah diurutkan: ";
            for (const auto& elem : arrayStringClone) {
                std::cout << elem << " ";
            }
