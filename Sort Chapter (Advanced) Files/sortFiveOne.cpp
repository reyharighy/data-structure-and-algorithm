/*
    ...
    mengurutkan data menggunakan In Place Sort. 
*/
...
void SortFiveOne::menuInterface() {
...
void SortFiveOne::sort() {
    std::cout << "\nPilih urutan pengoperasian pada in place sort:\n"
    ...
    if (sortChosen >= 1 && sortChosen <= 4){
        if (sortChosen == 1 && array.size()) {
            ...
            inPlaceSort(arrayClone, true); // Pengurutan naik Integer (Ascending)
        } else if (sortChosen == 2 && array.size()) {
            arrayClone = array; // Mengkloning array ke arrayClone
            inPlaceSort(arrayClone, false); // Pengurutan turun Integer (Descending)
        } else if (sortChosen == 3 && arrayString.size()) {
            arrayStringClone = arrayString; // Mengkloning arrayString ke arrayStringClone
            inPlaceSortString(arrayString, true); // Pengurutan naik String (Ascending)
        } else if (sortChosen == 4 && arrayString.size()) {
            arrayStringClone = arrayString; // Mengkloning arrayString ke arrayStringClone
            inPlaceSortString(arrayString, false); // Pengurutan turun String (Descending)
        } else { 
            std::cout << "<Data kosong>";
        }
    } else {
    ...
    while (true) {
        ...
        if (menuChosen >= 1 && menuChosen <= 5) {
            if (menuChosen == 1) {
                ...
                sort(); // Akses ke fungsi PART 4 dari "sortFiveOne.hpp"
