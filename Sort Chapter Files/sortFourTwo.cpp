...
void SortFourTwo::sort() {
    std::cout << "\nPilih urutan pengoperasian pada insertion sort:\n"
...
void SortFourTwo::start() {
    while (true) {
        ...
        if (menuChosen >= 1 && menuChosen <= 5) {
            if (menuChosen == 1) {
                push(); // Akses ke fungsi PART 2 dari "sortFourTwo.cpp"
            } else if (menuChosen == 2) {
                preview(); // Akses ke fungsi PART 3 dari "sortFourTwo.cpp"
            } else if (menuChosen == 3) {
                sort(); // Akses ke fungsi PART 4 dari "sortFourTwo.cpp"
            } else if (menuChosen == 4) {
                del(); // Akses ke fungsi PART 5 dari "sortFourTwo.cpp"
            } else {
                array.clear(); // Menghapus semua data dari array
                arrayString.clear(); // Menghapus semua data dari arrayString
                break;
