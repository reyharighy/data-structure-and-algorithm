...
void SortFourThree::menuInterface() {
    std::cout << "\nPilih menu untuk pengoperasian pada selection sort:\n"
...
/*----------------------------------------------------------------------------------------------------------------------------------------
    PART 4: Fungsi "sort" bertujuan untuk mengurutkan semua data menggunakan teknik pengurutan Selection Sort.
----------------------------------------------------------------------------------------------------------------------------------------*/

void SortFourThree::sort() {
    std::cout << "\nPilih urutan pengoperasian pada selection sort:\n"
    ...
    if (sortChosen >= 1 && sortChosen <= 4){
        if (sortChosen == 1 && array.size()) {
            ...
            selectionSort(arrayClone, true); // Pengurutan naik Integer (Ascending)
        } else if (sortChosen == 2 && array.size()) {
            arrayClone = array; // Mengkloning array ke arrayClone
            selectionSort(arrayClone, false); // Pengurutan turun Integer (Descending)
        } else if (sortChosen == 3 && arrayString.size()) {
            arrayStringClone = arrayString; // Mengkloning arrayString ke arrayStringClone
            selectionSortString(arrayStringClone, true); // Pengurutan naik String (Ascending)
        } else if (sortChosen == 4 && arrayString.size()) {
            arrayStringClone = arrayString; // Mengkloning arrayString ke arrayStringClone
            selectionSortString(arrayStringClone, false); // Pengurutan turun String (Descending)
        } else { 
            std::cout << "<Data kosong>";
        }
    } else {
...
void SortFourThree::start() {
    while (true) {
        ...
        if (menuChosen >= 1 && menuChosen <= 5) {
            if (menuChosen == 1) {
                push(); // Akses ke fungsi PART 2 dari "sortFourThree.cpp"
            } else if (menuChosen == 2) {
                preview(); // Akses ke fungsi PART 3 dari "sortFourThree.cpp"
            } else if (menuChosen == 3) {
                sort(); // Akses ke fungsi PART 4 dari "sortFourThree.cpp"
            } else if (menuChosen == 4) {
                del(); // Akses ke fungsi PART 5 dari "sortFourThree.cpp"
            } else {
                array.clear(); // Menghapus semua data dari array
                arrayString.clear(); // Menghapus semua data dari arrayString
                break;
